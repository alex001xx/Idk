...
local TRANSPARENCIA = 0.18
local TRANSPARENCIA_BOTON_ONOFF = TRANSPARENCIA * 0.6
local TRANSPARENCIA_BOTON_BLANCO = TRANSPARENCIA * 0.15
...
-- 🌸 Función para agregar florecitas decorativas
local function agregarFlorecitas(parent, cantidad)
    for i = 1, cantidad do
        local flor = Instance.new("TextLabel")
        flor.Size = UDim2.new(0, 16, 0, 16)
        flor.BackgroundTransparency = 1
        flor.Text = "🌸"
        flor.TextSize = 16
...
frame.BackgroundColor3 = COLOR_FONDO_VENTANA
...
statusLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255, 0.1)
...
onButton.MouseButton1Click:Connect(function()
    ...
    statusLabel.TextColor3 = Color3.fromRGB(0, 160, 60)
    isActive = true
end)
...
frame2.BackgroundColor3 = COLOR_FONDO_VENTANA
frame2.BackgroundTransparency = TRANSPARENCIA
frame2.Size = UDim2.new(0, 180, 0, 90)
frame2.Position = UDim2.new(0.5, -90, 0.5, -45)
frame2.Active = true
frame2.Draggable = true

agregarBarraMinimizable(frame2, 180, 90, "Punto de Control")
agregarFlorecitas(frame2, 2)
...
onButton2.Text = "On"
onButton2.TextColor3 = Color3.fromRGB(255, 255, 255)
...
offButton2.Text = "Off"
offButton2.TextColor3 = Color3.fromRGB(255, 255, 255)
...
destroyButton2.TextColor3 = Color3.fromRGB(0, 0, 0)
destroyButton2.TextScaled = true

local statusLabel2 = Instance.new("TextLabel")
statusLabel2.Parent = frame2
statusLabel2.BackgroundColor3 = Color3.fromRGB(255, 255, 255, 0.1)
statusLabel2.BackgroundTransparency = 0.85
...
local function createCheckpoint()
    ...
    checkpoint.BrickColor = BrickColor.new("Institutional White")
...
onButton2.MouseButton1Click:Connect(function()
    ...
    statusLabel2.TextColor3 = Color3.fromRGB(0, 160, 60)
end)
...
offButton2.MouseButton1Click:Connect(function()
    ...
    if checkpoint then checkpoint:Destroy() end
    statusLabel2.Text = "Status: Off"
    statusLabel2.TextColor3 = Color3.fromRGB(200, 0, 0)
end)
...
btnSeleccionarCercano.TextColor3 = Color3.fromRGB(0, 0, 0)
...
onButton3.Text = "On"
onButton3.TextColor3 = Color3.fromRGB(255, 255, 255)
...
offButton3.Text = "Off"
offButton3.TextColor3 = Color3.fromRGB(255, 255, 255)
...
destroyButton3.TextColor3 = Color3.fromRGB(0, 0, 0)
destroyButton3.TextScaled = true

local statusLabel3 = Instance.new("TextLabel")
statusLabel3.Parent = frame3
statusLabel3.BackgroundColor3 = Color3.fromRGB(255, 255, 255, 0.1)
statusLabel3.BackgroundTransparency = 0.85
...
onButton3.MouseButton1Click:Connect(function()
    ...
    statusLabel3.TextColor3 = Color3.fromRGB(0, 160, 60)
end)
